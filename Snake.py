...
def char_info():
    ...
    while r6 == True and g_exit == False:
        ...
        b_shiba = gameWindow.blit(b_shiba, (280, 150))
        '''
...
def char_sel():
    ...
    start_chartime = 0
    g_exit = False
    characters = ['Snake', 'Tinteev', 'Mankey', 'Shiba']
    if play_m == False and music_n == True:
        pygame.mixer.music.pause()
    ...
    while r7 == True and g_exit == False:
        ...
        button_tinteev = pygame.transform.scale(button_tinteev, (180, 90)).convert_alpha()
        button_tinteev = gameWindow.blit(button_tinteev, (140, 270))
        button_mankey = pygame.image.load("Game Data\\mankey.png")
        button_mankey = pygame.transform.scale(button_mankey, (180, 90)).convert_alpha()
        button_mankey = gameWindow.blit(button_mankey, (330, 270))
        '''
        ...
        button_shiba = pygame.transform.scale(button_shiba, (180, 90)).convert_alpha()
        button_shiba = gameWindow.blit(button_shiba, (520, 270))
        ''''
        ...
        if char_diff <= 10:
            ...
            text_screen2(str(10-char_diff) ,white,393,140)
        if char_diff == 10:
            instruct()
